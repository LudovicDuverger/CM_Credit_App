  ...
  return (
    <div className="detail-page">
      <div className="space-y-2">
        <h1 className="text-3xl font-bold tracking-tight text-slate-900">File prioritaire</h1>
        <p className="text-slate-600">Dossiers sensibles à traiter sous contrainte de délai (données factices)</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-white border border-slate-200 rounded-2xl p-5">
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="text-sm text-slate-500">Dossiers critiques</p>
        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-5">
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="text-sm text-slate-500">SLA moyen restant</p>
        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-5">
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="text-sm text-slate-500">Conformité prioritaire</p>
      ...
      <div className="bg-white border border-slate-200 rounded-2xl p-6">
        <div className="flex items-center justify-between mb-4">
          <h2 className="font-bold text-slate-900">Dossiers à escalade immédiate</h2>
          <span className="text-xs px-2 py-1 rounded-lg bg-slate-100 text-slate-600 flex items-center"><TrendingUp size={13} /> Temps réel</span>
        </div>
        <div className="overflow-x-auto">
          <table className="w-full min-w-[850px]">
            <thead>
              <tr className="text-left border-b border-slate-200">
                <th className="py-3 px-3 text-xs uppercase tracking-wider text-slate-500">ID</th>
                <th className="py-3 px-3 text-xs uppercase tracking-wider text-slate-500">Client</th>
                <th className="py-3 px-3 text-xs uppercase tracking-wider text-slate-500">Produit</th>
                <th className="py-3 px-3 text-xs uppercase tracking-wider text-slate-500">Montant</th>
                <th className="py-3 px-3 text-xs uppercase tracking-wider text-slate-500">SLA</th>
                <th className="py-3 px-3 text-xs uppercase tracking-wider text-slate-500">Motif</th>
              </tr>
            </thead>
            <tbody>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2">
        <div className="bg-white border border-slate-200 rounded-2xl p-6">
          <h3 className="font-bold text-slate-900 mb-4">Capacité de traitement prioritaire</h3>
        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-6">
          <h3 className="font-bold text-slate-900 mb-4">Actions recommandées (24h)</h3>
          <div className="space-y-3 text-sm text-slate-700">
            <div className="p-3 rounded-xl bg-slate-50 border border-slate-100">Escalader 2 dossiers &lt; 4h SLA vers cellule senior</div>
            <div className="p-3 rounded-xl bg-slate-50 border border-slate-100">Planifier 3 relances client avant 14h00</div>
            <div className="p-3 rounded-xl bg-slate-50 border border-slate-100">Bloquer nouveaux dossiers sur canal B pendant 2h</div>
            <div className="p-3 rounded-xl bg-slate-50 border border-slate-100">Valider 4 dossiers prêts comité pour gagner 1 jour</div>
          </div>
        </div>
      </div>
    </div>
